import { Github, Mail, Twitter, Linkedin, Code } from 'lucide-react';

const Footer = () => {
  return (
    <div className="flex flex-col items-center sm:flex-row sm:justify-between pb-4 pt-32">
      <div className="flex items-center">
        <a
          ...
          aria-label="linkedin"
        >
            <Linkedin className="h-[1.2rem] w-[1.2rem] mr-4 hover:animate-pulse" />
        </a>
        <a
          ...
          aria-label="github"
        >
            <Github className="h-[1.2rem] w-[1.2rem] mr-4 hover:animate-pulse" />
        </a>
        <a href="mailto:rohanpoojary10@gmail.com" aria-label="email">
            <Mail className="h-[1.2rem] w-[1.2rem] mr-4 hover:animate-pulse" />
        </a>
        <a
          ...
          aria-label="twitter"
        >
            <Twitter className="h-[1.2rem] w-[1.2rem] mr-4 hover:animate-pulse" />
        </a>
      </div>
